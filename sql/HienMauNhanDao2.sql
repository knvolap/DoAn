...
CREATE TABLE KetQuaHienMau(
	...
	idnguoiKham		VARCHAR(20) FOREIGN KEY REFERENCES dbo.NhanVienYTe(IdNVYT)  null,
	idnguoiXN		VARCHAR(20) FOREIGN KEY REFERENCES dbo.NhanVienYTe(IdNVYT)  null,
	idnguoiLayMau	VARCHAR(20) FOREIGN KEY REFERENCES dbo.NhanVienYTe(IdNVYT)  null,
